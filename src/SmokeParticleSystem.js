...
class SmokeParticleSystem {
  constructor(params) {
    ...
    this._colourSpline.AddPoint(0.0, new THREE.Color(0x808080));
    ...
    for (let i = 0; i < n; i++) {
      ...
      this._particles.push({
          position: new THREE.Vector3(
              (Math.random() * 30-15) * 1.0,
              (Math.random() * 10) * 1.0+70,
              (Math.random() * 20 - 10) * 1.0),
          ...
          velocity: new THREE.Vector3(20, 15, -5),
      });
    }
  }
